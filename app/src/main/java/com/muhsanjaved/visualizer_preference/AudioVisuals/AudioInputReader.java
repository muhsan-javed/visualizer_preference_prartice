package com.muhsanjaved.visualizer_preference.AudioVisuals;

import android.content.Context;
import android.media.MediaPlayer;
import android.media.audiofx.Visualizer;
import android.os.Build;
import com.muhsanjaved.visualizer_preference.R;
...
public class AudioInputReader {
    ...
    private void initVisualizer() {
        // Setup media player
        mPlayer = MediaPlayer.create(mContext, R.raw.app_src_main_res_raw_htmlthesong);
